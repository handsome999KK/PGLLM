...
def main(args):
    ...
    API_KEY = ""  #
    API_ENDPOINT = "https://api.atalk-ai.com/v2/chat/completions"  # ChatGPT API端点
    headers = {
    ...
    with open('GPT_results_OOD_{args.dataset_split}.json', 'w', encoding='utf-8') as f:
        json.dump(results, f, indent=2, ensure_ascii=False)

    print("Processing completed. Results saved to GPT_results_OOD.json")
